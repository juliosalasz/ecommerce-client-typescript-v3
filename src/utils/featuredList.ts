...
export const FeaturedList = [
  ...
  },
  {
    ...
    imageUrl: `${ServerUrl}graphic-Card.jpg`,
    price: "$300",
  ...
  },
  {
    ...
    imageUrl: `${ServerUrl}smartwatch.jpg`,
    price: "$100",
    route: "shop/videogames/playstation5",
  },
  {
    id: "254",
    name: "HTC VR HEADSET",
    imageUrl: `${ServerUrl}vrheadset.jpg`,
    price: "$600",
    route: "shop/videogames/playstation5",
  },
];
